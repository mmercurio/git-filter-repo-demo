...
Author: Michael Mercurio <michael@mmercurio.com>
...
Total 22 (delta 4), reused 14 (delta 3), pack-reused 0 (from 0)
...
```shell
$ git log newbranch
commit f313f198d5ccd4a461998df0c53445f95652c190 (newbranch)
...
In this example, we'll erase from history the secret `GIT_TOKEN` value which was added to and then removed from the file `files/config.txt`.

Even though the token was removed from the file and commited to the repo, we're able to examine the history to see that the secret token value is still available:
...
```shell
$ git show e38dab6ad68a8e5a71592ca83436c6becc2c6740
commit e38dab6ad68a8e5a71592ca83436c6becc2c6740 (origin/rm_git_token)
Author: Michael Mercurio <michael@mmercurio.com>
Date:   Fri Aug 30 23:02:45 2024 -0400
...
```shell
echo 'WGPmAapt4Bz04fNJVQyCYNpRjmg5ac0g' > ../passwords.txt
```
...
Writing objects: 100% (22/22), done.
Total 22 (delta 4), reused 6 (delta 0), pack-reused 0 (from 0)
...
Examining the details of the second commit removing the token reveals the secret token value has been replaced in the commit:
...
```shell
$ git remote add origin git@github.com:mmercurio/git-filter-repo-demo-filtered.git
$ git push origin --all --force
Enumerating objects: 11, done.
Counting objects: 100% (11/11), done.
Delta compression using up to 10 threads
Compressing objects: 100% (4/4), done.
Writing objects: 100% (9/9), 5.33 KiB | 5.33 MiB/s, done.
Total 9 (delta 2), reused 8 (delta 2), pack-reused 0 (from 0)
remote: Resolving deltas: 100% (2/2), done.
To github.com:mmercurio/git-filter-repo-demo-filtered.git
